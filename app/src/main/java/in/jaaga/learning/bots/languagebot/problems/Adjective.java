...
public class Adjective {
    ...
    public static HashMap<String, String> createAdjectiveProblem(String sentence1, Tokenizer tokenizer, POSTaggerME tagger) {
        ...
        HashMap adjective_hashmap = penntree.getPennTreeAdjectives();
        prompt += "Which is the adjective?";
        ...
        for (int i = 0; i<tokens.length; i++)
        {
            ...
            if (null != penntree_hashmap.get(tags[i])) {
                if (null != adjective_hashmap.get(tags[i])) {
